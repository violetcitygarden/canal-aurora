...
O personagem externo tem modelo próprio em `reporter.gd`: rosto mais estreito, pele morena, cabelo curto crespo, jaqueta ocre sem gravata, calça, sapatos e microfone Aurora. O enquadramento permite ver o corpo completo acima da faixa do jornal. Na transmissão normal, E continua solicitando uma reportagem gerada pelo Ollama com a voz Jeff.

## Ordem da transmissão
A chegada de uma matéria pronta não interrompe nenhuma fala. No automático, a próxima entrada espera o fim da narração e dois segundos de silêncio; sem áudio, espera o intervalo configurado. A pausa A impede trocas automáticas, inclusive a previsão. Espaço/G continuam sendo comandos explícitos de avanço.
...
`ABRIR-CANAL.bat` agora confere/baixa o modelo Jeff e testa uma síntese real no servidor HTTP antes de abrir o Godot. Se a porta 11436 estiver ocupada por um serviço antigo ou incompatível, procura outra até 11446 e passa a porta escolhida ao Godot por AURORA_VOICE_PORT. Não encerra processos. Um servidor compatível na porta examinada pode ser reutilizado. O terminal fica aberto quando a abertura falha.
...
## Profundidade dos cenários externos
A rua agora parte de uma calçada com juntas de piso, faixa tátil, bueiro, padaria, ponto de ônibus, carro estacionado e avenida que se estende ao fundo. O campo tem vegetação próxima, cerca e caminho longos, construção distante e três camadas de relevo. À noite, o repórter está num pequeno platô: a cidade ocupa o vale abaixo, entre 75 e 245 unidades de distância, com prédios, janelas acesas, iluminação viária e montanhas atrás. O céu tem gradiente, lua e estrelas. Geometria próxima recebe mais detalhes; luzes e edifícios distantes usam MultiMesh para agrupar o desenho. F3 percorre os três ambientes no teste do repórter.
